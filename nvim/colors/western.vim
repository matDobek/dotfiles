" western.vim -- Vim color scheme.
" Author:      matDobek (mat.dobek@gmail.com)
" Webpage:     
" Description: Minimal colorscheme, low contrast, soft colors.
" Last Change: 2023-12-25
...
let colors_name = "western"

if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal ctermbg=235 ctermfg=251 cterm=NONE guibg=#262626 guifg=#F3EED9 gui=NONE
    ...
    hi Constant ctermbg=bg ctermfg=140 cterm=NONE guibg=bg guifg=#A75F6D gui=NONE
    hi Identifier ctermbg=bg ctermfg=251 cterm=NONE guibg=bg guifg=#F3EED9 gui=NONE
    hi Statement ctermbg=bg ctermfg=243 cterm=NONE guibg=bg guifg=#767676 gui=NONE
    hi Operator ctermbg=bg ctermfg=251 cterm=NONE guibg=bg guifg=#F3EED9 gui=NONE
    hi PreProc ctermbg=bg ctermfg=243 cterm=NONE guibg=bg guifg=#767676 gui=NONE
    hi Type ctermbg=bg ctermfg=251 cterm=NONE guibg=bg guifg=#F3EED9 gui=NONE
    hi Special ctermbg=NONE ctermfg=243 cterm=NONE guibg=NONE guifg=#767676 gui=NONE
    hi Error ctermbg=NONE ctermfg=132 cterm=NONE guibg=NONE guifg=#ff727c gui=NONE
    hi Warning ctermbg=NONE ctermfg=179 cterm=NONE guibg=NONE guifg=#f2e0c0 gui=NONE
    ...
    hi Underlined ctermbg=NONE ctermfg=251 cterm=underline guibg=NONE guifg=#F3EED9 gui=underline
    hi StatusLine ctermbg=237 ctermfg=140 cterm=NONE guibg=#3a3a3a guifg=#A75F6D gui=NONE
    ...
    hi Title ctermbg=NONE ctermfg=251 cterm=bold guibg=NONE guifg=#F3EED9 gui=bold
    hi LineNr ctermbg=NONE ctermfg=241 cterm=NONE guibg=NONE guifg=#626262 gui=NONE
    hi CursorLineNr ctermbg=236 ctermfg=140 cterm=NONE guibg=#303030 guifg=#A75F6D gui=NONE
    hi Cursor ctermbg=140 ctermfg=251 cterm=NONE guibg=#A75F6D guifg=#F3EED9 gui=NONE
    ...
    hi PmenuSel ctermbg=236 ctermfg=140 cterm=NONE guibg=#303030 guifg=#A75F6D gui=NONE
    ...
    hi Search ctermbg=140 ctermfg=235 cterm=NONE guibg=#A75F6D guifg=#262626 gui=NONE
    hi Directory ctermbg=NONE ctermfg=140 cterm=NONE guibg=NONE guifg=#A75F6D gui=NONE
    hi MatchParen ctermbg=NONE ctermfg=167 cterm=bold guibg=NONE guifg=#d75f5f gui=bold
    hi SpellBad ctermbg=NONE ctermfg=132 cterm=underline guibg=NONE guifg=#ff727c gui=underline
    hi SpellCap ctermbg=NONE ctermfg=108 cterm=underline guibg=NONE guifg=#a6c982 gui=underline
    hi SpellLocal ctermbg=NONE ctermfg=179 cterm=underline guibg=NONE guifg=#f2e0c0 gui=underline
    hi QuickFixLine ctermbg=234 ctermfg=NONE cterm=NONE guibg=#1c1c1c guifg=NONE gui=NONE
    hi DiffAdd ctermbg=236 ctermfg=108 cterm=NONE guibg=#303030 guifg=#a6c982 gui=NONE
    hi DiffChange ctermbg=236 ctermfg=NONE cterm=NONE guibg=#303030 guifg=NONE gui=NONE
    hi DiffDelete ctermbg=236 ctermfg=132 cterm=NONE guibg=#303030 guifg=#ff727c gui=NONE
    hi DiffText ctermbg=236 ctermfg=179 cterm=NONE guibg=#303030 guifg=#f2e0c0 gui=NONE
    hi helpHyperTextJump ctermbg=bg ctermfg=140 cterm=NONE guibg=bg guifg=#A75F6D gui=NONE
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = [ '#3a3a3a', '#ac2c2c', '#4e9a06', '#c4a000', '#1880bc', '#75507b', '#389aad', '#9e9e9e', '#444444', '#ff727c', '#a6c982', '#f2e0c0', '#369dd8', '#A75F6D', '#34e2e2', '#b2b2b2' ]
endif
